...
export function useKeyboardOffsetVariable() {
    const { offset } = useMobileKeyboard();
    useEffect(() => {
        document.documentElement.style.setProperty('--keyboard-offset', `${offset}px`);
        return () => document.documentElement.style.removeProperty('--keyboard-offset');
    }, [offset]);
}
//# sourceMappingURL=useMobileKeyboard.js.map